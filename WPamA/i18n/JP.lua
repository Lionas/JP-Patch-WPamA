...
-- Chat
  ...
  RGLA = {
    ...
    F2 = "AutoInvite及びAutoShareで参加するには、以下のいずれかの文字列をチャットから入力してください。\"<<1>>",
    F3 = "AutoInviteで参加するには、以下のいずれかの文字列をチャットから入力してください。\"<<1>>",
    F4 = "\" , \"<<1>>",
    F5 = "\" ( <<1>> ).",
    F6 = "/z AutoInvite及びAutoShareで \"<<1>>\" の参加を募集しています。",
    F7 = "/z AutoInviteで \"<<1>>\" の参加を募集しています。",
    F8 = "<<1>> あと1分で <<2>> を開始します。",
    F9 = "/p <<1>> を開始します。",
    F10 = "/z <<1>> は倒されました。",
